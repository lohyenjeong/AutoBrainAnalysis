...
inDir = "/opt/imperialinput"
outDir = "/opt/imperialoutput"
...
while (True):
  ...
  for fileName in currFiles:
    if fileName not in oldFiles:
      ...
      #return_code = 0
      return_code = subprocess.call(['/opt/malpem-1.2/bin/malpem-proot','-i',fileFullName,'-o','/opt/malpem-1.2/outputDir', '-t', '15', '-c'])
