...
$upload_location = $params->get( 'upload_location', '.'.DIRECTORY_SEPARATOR.'ul_scans' );
...
if (strlen($filename) > 0) {
	...
	if ($tmp_upload_capthca == 0) {
		if ($_SESSION["uploaderr$mid"] == 0) {
			...
			$results .= ModSimpleFileUploaderHelperv13::getUploadForm($params, $upload_location, $sfu_basepath, $mid, $upload_users, $users_name, $usr_name);
